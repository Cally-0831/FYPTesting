...
update allsupersetting set deadlinedate = "2024-03-15", deadlinetime = "22:00" where stid = "stidqBQSy";
insert into allnotice values("nidstidqBQSy","admin","Admin", now(),"4","Presentation Schdeule Release Date","The release date for presentation schdeule has been set as follows: newline Date: 15/03/2024 newline Time: 22:00:00 newline  newline All users can check and their personal timeslots after the release of the schdeule.");
